...
<html lang="en">
	...
	<body>
		...
		<div class="jumbotron text-center">
		  ...
		  <p>Odaberi jedan od nogometnih termina!</p> 
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<img src="slike/nogomet.jpg" class="img-fluid border border-primary" alt="nogomet">
				</div>
				...
				<div class="col-sm-8">
					...
					if(isset($_SESSION["usersId"]))
					{
						...
						<form action = "nogomet.base.php" method = "post">
						
							<div class = "form-group mb-3">
							
								<input type="hidden" name = "korisnici" value = ' . $_SESSION["usersEmail"] . '>
							
								<input type="hidden" name = "sportoviNames" value = "nogomet">
