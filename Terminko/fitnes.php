...
<html lang="en">
	...
	<body>
		...
		<div class="jumbotron text-center">
		  ...
		  <h1>Fitnes termini</h1>
		  
		  <p>Odaberi jedan od Fitnes termina!</p> 
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-4">
					<img src="slike/fitnes.jpg" class="img-fluid border border-primary" alt="fitnes">
				</div>
				...
				<div class="col-sm-8">
					...
					if(isset($_SESSION["usersId"]))
					{
						...
						<form action = "fitnes.base.php" method = "post">
						
							<div class = "form-group mb-3">
							
								<input type="hidden" name = "korisnici" value = ' . $_SESSION["usersEmail"] . '>
							
								<input type="hidden" name = "sportoviNames" value = "fitnes">
